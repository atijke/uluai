# Doc: https://github.com/LonamiWebs/Telethon/wiki/Sending-more-than-just-messages#sending-spoilers-and-custom-emoji
...
class CustomHTMLParseMode:
    ...
    def unparse(text: str, entities: Iterable[TypeMessageEntity]) -> str:
        ...
        for i, entity in enumerate(entities):
            ...
            delimiter = CUSTOM_ENTITY_TO_FORMATTER.get(type(entity), None)
            if delimiter:
